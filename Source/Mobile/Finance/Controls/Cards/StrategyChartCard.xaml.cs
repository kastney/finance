...
/// <summary>
/// Representa um cartão visual com gráfico de pizza, exibindo a estratégia de alocação dos grupos de ativos.
/// </summary>
public partial class StrategyChartCard : ContentView {
    ...
    /// <summary>
    /// Inicializa uma nova instância do componente <see cref="StrategyChartCard"/>.
    /// </summary>
    public StrategyChartCard() {
    ...
    private static void OnPercentageAvailableChanged(BindableObject bindable, object oldValue, object newValue) {
        // Verifica se o objeto associado é do tipo StrategyChartCard e se o novo valor é um inteiro.
    ...
    private static void OnDataChanged(BindableObject bindable, object oldValue, object newValue) {
        // Verifica se o objeto associado é do tipo StrategyChartCard e se o novo valor é uma lista de PieData.
        if(bindable is not StrategyChartCard control || newValue is not List<PieData> list) { return; }
        ...
        for(int i = 0; i < pallet.Length; i++) {
            ...
            pallet[i] = ColorUtility.GetColor(list[i].Color);
        }
